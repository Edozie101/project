			...
			development: {
				constants: {
					ENV: {
						...
						// dataProvider: 'REMOTE',
						// apiUrl: 'https://skounis.s3.amazonaws.com/mobile-apps/realestate/',
						// dataProvider: 'LOCAL',
						// apiUrl: 'misc/',
						metric: 'miles', // miles or km
						dataProvider: 'FIREBASE',
						firebaseConfig: {
							apiKey: "AIzaSyBMxTcqmv1PvclqbAPz0a22bklsVjXu-9Y",
							authDomain: "realestate-as-b9a5c.firebaseapp.com",
							databaseURL: "https://realestate-as-b9a5c.firebaseio.com"
						},
